...
NATIVE_AMERICAN_TERMS: set[str] = {
    "abenaki", "abnaki", "acoma", "algonquin", "algonkin", "apache",
    "arapaho", "assiniboine", "athabascan", "bannock", "blackfoot",
    "blackfeet", "blood", "brule", "caddo", "catawba", "cayuga",
    "cayuse", "cherokee", "cheyenne", "chickasaw", "chinook",
    "chippewa", "chiricahua", "choctaw", "chumash", "cochiti",
    "comanche", "cree", "creek", "crow", "dakota", "delaware",
    "erie", "flathead", "havasupai", "hidatsa", "ho-chunk", "hopi",
    "huron", "illinois", "iowa", "iroquois", "isleta", "jemez",
    "jicarilla", "kansa", "kaw", "kickapoo", "kiowa", "kootenai",
    "laguna", "lakota", "lenape", "lumbee", "mahican", "mandan",
    "maricopa", "maliseet", "mashantucket", "mdewakanton", "menominee",
    "mescalero", "miami", "micmac", "mikmaq", "miniconjou", "miwok",
    "mohawk", "mohegan", "mohican", "muscogee", "nakoda", "nakota",
    "nanticoke", "narragansett", "navaho", "navajo", "nez-perce",
    "niantic", "nipmuc", "oglala", "ojibwe", "ojibwa", "omaha",
    "oneida", "onondaga", "osage", "ottawa", "paiute", "pamunkey",
    "passamaquoddy", "pawnee", "peigan", "penobscot", "pequot",
    "piegan", "pima", "piscataway", "ponca", "potawatomi", "powhatan",
    "pueblo", "quapaw", "rappahannock", "sahnish", "salish",
    "san-carlos", "santa-clara", "sauk", "seminole", "seneca",
    "shawnee", "shinnecock", "shoshone", "shoshoni", "sioux",
    "sisseton", "spokane", "stoney", "susquehannock", "taos",
    "tesuque", "tohono", "tonkawa", "tonto", "tsalagi", "tuscarora",
    "tutelo", "ute", "wahpeton", "wampanoag", "washoe", "wea",
    "wichita", "winnebago", "wyandot", "yakama", "yanktonai",
    "yaqui", "yavapai", "yokuts", "yuma", "zuni",
    "lipan", "white-mountain", "fort-sill", "yavapai-apache",
}
...
GENERIC_TERMS: set[str] = {
    "data", "cloud", "stream", "flow", "pipe", "queue", "store",
    "cache", "index", "search", "query", "compute", "service",
    "platform", "framework", "engine", "server", "client",
    "tool", "kit", "lib", "core", "base", "hub", "net", "web",
    "api", "sdk", "db", "sql", "ml", "ai", "open", "free",
}
...
def check_format(name: str) -> tuple[list[str], list[str]]:
    ...
    if re.search(r"\d", stripped):
        warnings.append(
            "Name contains digits, which can complicate trademark registration."
        )
...
def policy_guidance(topic: str) -> dict:
    ...
    if topic not in _GUIDANCE:
        raise ValueError(
            f"Unknown topic '{topic}'. Available: " + ", ".join(sorted(_GUIDANCE))
        )
